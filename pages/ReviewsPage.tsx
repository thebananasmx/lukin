...
const LoadingState = () => {
    ...
    return (
        <div className="text-center flex flex-col items-center justify-center p-8 space-y-6 my-12 bg-gray-800/60 backdrop-blur-sm rounded-3xl shadow-2xl border border-gray-700/50">
            <SpinnerIcon />
            <h2 className="text-2xl font-bold text-white">Generando tu página de Social Proof...</h2>
            <p className="text-gray-400 text-lg transition-opacity duration-500 h-6">
